...
- ایندکس یکتای جزئی `uq_attachments_stored_filename_live` مقدار NULL را
  تحمل می‌کند؛ ردیف‌های فقط-یادداشت هرگز تداخل ندارند.
...
- بارگذاری از مسیر کلاینت axios است (`api.post` با `FormData`؛ antd
  ...
  هرگز مسیر آپلود خودکار antd که از interceptor تمدید توکن عبور نمی‌کند.
